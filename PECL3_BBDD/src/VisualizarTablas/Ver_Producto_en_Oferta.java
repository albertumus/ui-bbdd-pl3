 ...
 * @author razvanvc
 */
public class Ver_Producto_en_Oferta extends javax.swing.JFrame {
     ...
     */
    public Ver_Producto_en_Oferta(Connection c) {
        Ver_Producto_en_Oferta.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Producto_en_Oferta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Producto_en_Oferta(conexion).setVisible(true);
            }
        });
    }
    ...
    private void mostrar() {
        ...
        try {
            rs = s.executeQuery("SELECT * FROM producto_en_oferta");
