 ...
 * @author razvanvc
 */
public class Ver_Trabajador_Puntua_Trabajador extends javax.swing.JFrame {
     ...
     */
    public Ver_Trabajador_Puntua_Trabajador(Connection c) {
        Ver_Trabajador_Puntua_Trabajador.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Trabajador_Puntua_Trabajador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Trabajador_Puntua_Trabajador(conexion).setVisible(true);
            }
        });
    }
    ...
    private void mostrar() {
        ...
        try {
            rs = s.executeQuery("SELECT * FROM trabajador_puntua_trabajador");
