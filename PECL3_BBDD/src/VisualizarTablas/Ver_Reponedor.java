 ...
 * @author razvanvc
 */
public class Ver_Reponedor extends javax.swing.JFrame {
     ...
     */
    public Ver_Reponedor(Connection c) {
        Ver_Reponedor.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Reponedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Reponedor(conexion).setVisible(true);
            }
        });
    }
