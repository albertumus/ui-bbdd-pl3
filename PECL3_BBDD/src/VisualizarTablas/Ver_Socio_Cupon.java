 ...
 * @author razvanvc
 */
public class Ver_Socio_Cupon extends javax.swing.JFrame {
     ...
     */
    public Ver_Socio_Cupon(Connection c) {
        Ver_Socio_Cupon.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Socio_Cupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Socio_Cupon(conexion).setVisible(true);
            }
        });
    }
    ...
    private void mostrar() {
        ...
        try {
            rs = s.executeQuery("SELECT * FROM socios_cupon");
