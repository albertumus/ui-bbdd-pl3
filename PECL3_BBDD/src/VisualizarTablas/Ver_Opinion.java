 ...
 * @author razvanvc
 */
public class Ver_Opinion extends javax.swing.JFrame {
     ...
     */
    public Ver_Opinion(Connection c) {
        Ver_Opinion.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Opinion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Opinion(conexion).setVisible(true);
            }
        });
    }
