 ...
 * @author razvanvc
 */
public class Ver_Ticket extends javax.swing.JFrame {
     ...
     */
    public Ver_Ticket(Connection c) {
        Ver_Ticket.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Ticket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Ticket(conexion).setVisible(true);
            }
        });
    }
