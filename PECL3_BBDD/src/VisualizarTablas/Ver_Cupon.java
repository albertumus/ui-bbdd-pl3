 ...
 * @author razvanvc
 */
public class Ver_Cupon extends javax.swing.JFrame {
     ...
     */
    public Ver_Cupon(Connection c) {
        Ver_Cupon.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Cupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Cupon(conexion).setVisible(true);
            }
        });
    }
