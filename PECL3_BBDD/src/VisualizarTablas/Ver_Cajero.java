 ...
 * @author razvanvc
 */
public class Ver_Cajero extends javax.swing.JFrame {
     ...
     */
    public Ver_Cajero(Connection c) {
        Ver_Cajero.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Cajero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Cajero(conexion).setVisible(true);
            }
        });
    }
