 ...
 * @author razvanvc
 */
public class Ver_Productos_Comprados extends javax.swing.JFrame {
     ...
     */
    public Ver_Productos_Comprados(Connection c) {
        Ver_Productos_Comprados.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Productos_Comprados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Productos_Comprados(conexion).setVisible(true);
            }
        });
    }
    ...
    private void mostrar() {
        ...
        try {
            rs = s.executeQuery("SELECT * FROM productos_comprados");
