 ...
 * @author razvanvc
 */
public class Ver_Socio extends javax.swing.JFrame {
     ...
     */
    public Ver_Socio(Connection c) {
        Ver_Socio.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Socio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Socio(conexion).setVisible(true);
            }
        });
    }
