 ...
 * @author razvanvc
 */
public class Ver_Tienda extends javax.swing.JFrame {
     ...
     */
    public Ver_Tienda(Connection c) {
        Ver_Tienda.conexion = c;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Tienda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Tienda(conexion).setVisible(true);
            }
        });
    }
