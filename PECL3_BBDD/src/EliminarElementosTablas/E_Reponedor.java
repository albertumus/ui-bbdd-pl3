 ...
 * @author razvanvc
 */
public class E_Reponedor extends javax.swing.JFrame {

    public static Connection conexion;
    /**
     * Creates new form E_Tienda
     */
    public E_Reponedor(Connection c) {
        E_Reponedor.conexion = c;
        initComponents();
        rellenaCB();
    }
    ...
    private void initComponents() {
        ...
        lbl_Info.setText("Selecciona el reponedor que quieras eliminar");
    ...
    private void btn_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_DeleteActionPerformed
        ...
        try {
            //if(tf_Nombre.equals(""))
            s.executeUpdate("DELETE FROM reponedor WHERE dni_trabajador = '"+cb_TS.getItemAt(cb_TS.getSelectedIndex())+"'");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
        }
        confirmacion("¿Desea eliminar mas reponedores?","Eliminar Reponedor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(E_Reponedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new E_Reponedor(conexion).setVisible(true);
            }
        });
    }
