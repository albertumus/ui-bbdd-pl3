 ...
 * @author razvanvc
 */
public class E_Cajero extends javax.swing.JFrame {

    public static Connection conexion;
    /**
     * Creates new form E_Tienda
     */
    public E_Cajero(Connection c) {
        E_Cajero.conexion = c;
        initComponents();
        rellenaCB();
    }
    ...
    private void initComponents() {
        ...
        lbl_Info.setText("Selecciona el cajero que quieras eliminar");
    ...
    private void btn_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_DeleteActionPerformed
        ...
        try {
            //if(tf_Nombre.equals(""))
            s.executeUpdate("DELETE FROM cajero WHERE dni_trabajador = '"+cb_TS.getItemAt(cb_TS.getSelectedIndex())+"'");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
        }
        confirmacion("¿Desea eliminar mas cajeros?","Eliminar Cajero");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(E_Cajero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new E_Cajero(conexion).setVisible(true);
            }
        });
    }
    ...
    private void confirmacion(String P,String T) {
        ...
        if (n == JOptionPane.YES_OPTION) {
            E_Cajero ventana = new E_Cajero(conexion);
