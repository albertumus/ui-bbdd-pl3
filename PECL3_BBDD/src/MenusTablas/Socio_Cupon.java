 ...
 * @author razvanvc
 */
public class Socio_Cupon extends javax.swing.JFrame {
public static Connection conexion;
    /**
     * Creates new form Tienda
     */
    public Socio_Cupon(Connection c) {
        Socio_Cupon.conexion = c;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Socio_Cupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    //</editor-fold>
    //</editor-fold>
    //</editor-fold>
    ...
    //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Socio_Cupon(conexion).setVisible(true);
            }
        });
    }
