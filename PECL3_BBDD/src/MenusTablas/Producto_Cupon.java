 ...
 * @author razvanvc
 */
public class Producto_Cupon extends javax.swing.JFrame {
public static Connection conexion;
    /**
     * Creates new form Tienda
     */
    public Producto_Cupon(Connection c) {
        Producto_Cupon.conexion = c;
        initComponents();
    }
...
//        ventana.setVisible(true);
    ...
    private void btn_VerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_VerActionPerformed
        // TODO add your handling code here:
        Ver_Producto_Cupon ventana = new Ver_Producto_Cupon(conexion);
        ventana.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Producto_Cupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    //</editor-fold>
    //</editor-fold>
    //</editor-fold>
    ...
    //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Producto_Cupon(conexion).setVisible(true);
            }
        });
    }
