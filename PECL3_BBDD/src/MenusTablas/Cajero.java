...
import EliminarElementosTablas.E_Cajero;
import InsertarElementos.N_Cajero;
import InsertarElementos.N_Productos_Comprados;
import VisualizarTablas.Ver_Cajero;
...
public class Cajero extends javax.swing.JFrame {
    ...
    private void btn_VerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_VerActionPerformed
        // TODO add your handling code here:
        Ver_Cajero ventana = new Ver_Cajero(conexion);
        ventana.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Cajero(conexion).setVisible(true);
            }
        });
    }
