 ...
 * @author razvanvc
 */
public class Vista_Gestor extends javax.swing.JFrame {
    ...
    public Vista_Gestor(Connection c) {
        Vista_Gestor.conexion = c;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_Gestor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_Gestor(conexion).setVisible(true);
            }
        });
    }
